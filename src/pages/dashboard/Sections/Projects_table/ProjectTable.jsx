...
import { getProjectList } from "../../../../api/api_atrib";
...
export default function ProjectTable() {
  ...
  const obtenerProyectos = async () => {
    try {
      ...
      setProjectList(proyectos.data); // Actualiza el estado con las categorías obtenidas
    } catch (error) {
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td className={classes}>
                        ...
                        <ModalUpdateProject isOpen={isUpdateOpen} onClose={closeUpdate} id={currentProjectId}/>
                      </td>
                    </tr>
                  );
                }
